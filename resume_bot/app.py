...
def record_user_details(email, notes="not provided"):
    send_email(email, f"Recording email {email} and notes {notes}")
    return {"recorded": "ok"}

def record_unknown_question(email, question="not provided"):
    send_email(email, f"Recording email {email} and question {question}")
    return {"recorded": "ok"}
...
class Me:
    ...
    def system_prompt(self):
        ...
        Be professional and engaging, as if talking to a potential recruiter or future employer who came across the website. \
